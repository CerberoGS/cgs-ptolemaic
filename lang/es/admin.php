...
return [
    ...
    'telegram_config' => [
        ...
        'description' => 'Configura las alertas de seguridad vía Telegram',
        'configuration' => 'Configuración',
        'config_description' => 'Configura tu bot de Telegram para recibir alertas de seguridad',
        'bot_token' => 'Token del Bot',
        'bot_token_help' => 'Obtén tu token del BotFather en Telegram',
        'chat_id' => 'ID del Chat',
        'chat_id_help' => 'ID del chat donde recibirás las alertas',
        'enable_alerts' => 'Habilitar Alertas',
        'test_configuration' => 'Probar Configuración',
        'test_description' => 'Envía un mensaje de prueba para verificar la configuración',
        'test_chat_id' => 'ID del Chat de Prueba',
        'test_chat_id_help' => 'ID del chat donde enviar el mensaje de prueba',
        'test_message' => 'Mensaje de Prueba',
        'test_message_placeholder' => '¡Hola! Este es un mensaje de prueba de CGS Ptolemaic',
        ...
        'security_note' => 'Las alertas de Telegram se envían solo para eventos críticos de seguridad como nuevos inicios de sesión, intentos de login fallidos y cambios de contraseña.',
        'active' => 'Activo',
        'inactive' => 'Inactivo',
    ],
];
