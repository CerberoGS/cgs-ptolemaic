...
class AdminProviderController extends Controller
{
    ...
    public function update(UpdateProviderRequest $request, string $locale, string $type, string $provider): RedirectResponse
    {
        ...
        $record->update($this->buildPayload($providerType, $request->validated()));
     ...
     */
    protected function buildPayload(ProviderType $type, array $data): array
    {
        $payload = [];
